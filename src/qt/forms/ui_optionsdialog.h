...
public:
    ...
    QCheckBox *minmontcoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        minmontcoinAtStartup = new QCheckBox(tabMain);
        minmontcoinAtStartup->setObjectName(QStringLiteral("minmontcoinAtStartup"));

        verticalLayout_Main->addWidget(minmontcoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        minmontcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Bitcoin Core after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        minmontcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Minmontcoin Core on system login", 0));
