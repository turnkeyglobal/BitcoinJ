...
#include "minmontcoinamountfield.h"
...
public:
    ...
    MinmontcoinAmountField *customFee;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 INV"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 INV"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 INV"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 INV"));
        ...
        customFee = new MinmontcoinAmountField(frameFeeSelection);
        ...
        labelBalance->setText(QStringLiteral("123.456 INV"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for minmontcoin transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for minmontcoin transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
