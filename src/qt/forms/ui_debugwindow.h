...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        gridLayout->addWidget(openSSLVersion, 4, 1, 1, 2);
        ...
        gridLayout->addWidget(label_berkeleyDBVersion, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(berkeleyDBVersion, 5, 1, 1, 2);
        ...
        gridLayout->addWidget(buildDate, 6, 1, 1, 2);
        ...
        gridLayout->addWidget(startupTime, 7, 1, 1, 2);
        ...
        gridLayout->addWidget(networkName, 9, 1, 1, 2);
        ...
        gridLayout->addWidget(numberOfConnections, 10, 1, 1, 2);
        ...
        gridLayout->addWidget(labelNetwork, 8, 0, 1, 1);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Minmontcoin Core debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
