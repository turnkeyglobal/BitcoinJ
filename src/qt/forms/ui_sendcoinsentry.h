...
public:
    ...
    MinmontcoinAmountField *payAmount;
    ...
    MinmontcoinAmountField *payAmount_is;
    ...
    MinmontcoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new MinmontcoinAmountField(SendCoins);
        ...
        payAmount_is = new MinmontcoinAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new MinmontcoinAmountField(SendCoins_AuthenticatedPaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less Bitcoin than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0));
#endif // QT_NO_TOOLTIP
