/* src/config/minmontcoin-config.h.  Generated from minmontcoin-config.h.in by configure.  */
/* src/config/minmontcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/minmontcoin/minmontcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Investcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Investcoin Core 0.12.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "minmontcoin"
